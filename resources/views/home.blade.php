    ...
    <main>
        <aside>
            <ul>
                ...
                <li><a href="#" data-open="boardModal">Boards</a></li>
        ...
        <section class="main-section">
            <div class="section-wrapper">
                <div class="row">
                    <div id="boardModal" data-reveal role="dialogue"
                         style="background: #ffffff; width: 50; height: 100%;margin-top: 20%; margin-left: 50%;">
                        <main class="login">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="column-12">
                                            <div class="form">
                                                <div class="controls">
                                                    <select class="form-control width-100-percent" id="Position"
                                                            name="Position">
                                                        <option value="">Select Member Position</option>
                                                        <option value="Board Chair">Board Chair</option>
                                                        <option value="Executive Director (ED)">Executive Director
                                                            (ED)
                                                        </option>
                                                        ...
                                                        <option value="President &amp; Chairperson">President &amp;
                                                            Chairperson
                                                        </option>
                                                        ...
                                                        <option value="Immediate Past President">Immediate Past
                                                            President
                                                        </option>
                                                        <option value="Immediate Past Chair">Immediate Past Chair
                                                        </option>
