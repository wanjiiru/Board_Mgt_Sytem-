    ...
    <main>
        ...
        <section class="main-section">
            <div class="section-wrapper">
                <div class="row">
                    <div id="boardModal" data-reveal role="dialogue" style="background: #ffffff; width: 50; height: 100%;margin-top: 20%; margin-left: 50%;">
                        <main class="login">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="column column-12"><button class="button">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </main>
