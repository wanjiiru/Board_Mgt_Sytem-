                    ...
                    <div id="{{$meeting->id}}">
                        <div class="meeting-content">
                            <dl class="fields-list">
                                ...
                                <dt>Date:</dt>
                                <dd class="date">{!! $meeting->date  !!} <span class="repeat-description"></span></dd>
                                <dt>Location:</dt>
                                <dd><a href="https://maps.google.com/?q=alma" target="_blank">{!! $meeting->location  !!}</a></dd>
                            </dl></div></div></div></div></div></div></section>
                @endforeach
